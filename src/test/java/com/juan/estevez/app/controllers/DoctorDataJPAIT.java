...
public class DoctorDataJPAIT {
	...
	@Test
	//@DisplayName("Este test debería hacer cualquier cosa")
	...
	@Test
	void listDoctors() {
		ResponseEntity<Doctor[]> response = testRestTemplate.getForEntity("http://localhost:8080/doctor/findAll", Doctor[].class);
		List<Object> doctors = Arrays.asList(response.getBody());
